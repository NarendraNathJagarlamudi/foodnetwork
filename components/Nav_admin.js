...
export default function Nav({ show }) {
  ...
  return (
    ...
    >
      ...
      <Link
        href={"/"}
        className="flex gap-1 p-1 backToUserLink hover:opacity-80 transition-opacity"
      >
        <svg
        ...
        <h1 className="backToUserLink">Back to User's Page</h1>
      </Link>
      <nav className="mt-10 flex flex-col gap-2">
        ...
        <Link
          href={"/products_admin"}
          className={
            pathname.includes("/products_admin") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          href={"/categories_admin"}
          className={
            pathname.includes("/categories_admin") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <Link
          href={"/orders_admin"}
          className={
            pathname.includes("/orders_admin") ? activeLink : inactiveLink
          }
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
